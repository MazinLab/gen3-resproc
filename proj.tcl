...
# Source Block Design.
set file "[file normalize "$origin_dir/bd/resproc.tcl"]"
source $file
...
# Create HDL Wrapper.
make_wrapper -files [get_files resproc.bd] -top

# Add files to sources_1 fileset
set files [list \
  [file normalize "${origin_dir}/top/top.srcs/sources_1/bd/d_1/hdl/resproc_wrapper.v" ]\
]
add_files -fileset $obj $files
